...
export const KNOWN_INSTRUMENTS = new Set(["BTC", "ETH", "SOL", "XRP", "BNB", "ADA", "LTC", "LINK", "XLM", "TRX", "ETC", "DOGE"]);
...
export const DB_SUFFIX = { BTC: "", ETH: "-eth", SOL: "-sol", XRP: "-xrp", BNB: "-bnb", ADA: "-ada", LTC: "-ltc", LINK: "-link", XLM: "-xlm", TRX: "-trx", ETC: "-etc", DOGE: "-doge" };
