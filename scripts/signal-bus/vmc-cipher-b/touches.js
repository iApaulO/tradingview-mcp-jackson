// Ported verbatim from scripts/signal-bus/divergence-for-many/touches.js (2026-07-31) -- Cipher
// B's divergence zones are single-price-line, exactly like Divergence-for-Many's, so this logic
// applies unchanged. Kept as a per-indicator copy (not a shared import) to match this project's
// existing convention: SMC's touches.js is a genuinely different implementation (range-based
// order blocks, not price-line zones), so each indicator directory owns its own copy rather than
// sharing code that happens to coincide today but might not stay generic forever.
//
